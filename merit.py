list = [{"name":"Coco Veillard","authorised":"Gemma ","service":"B"},{"name":"Fleur Veillard","authorised":"Gemma ","service":"B"},{"name":"Amelia Jallot","authorised":"Gemma ","service":"B"},{"name":"Joseph Morley","authorised":"Gemma ","service":"B"},{"name":"William Digance","authorised":"Gemma ","service":"B"},{"name":"Victor Muangman","authorised":"Flo","service":"B"},{"name":"Dara Spasova","authorised":"Flo","service":"B"},{"name":"Nathan Farmer","authorised":"Flo","service":"B"},{"name":"Harry Swan","authorised":"Flo","service":"B"},{"name":"Nick Bukhantsov","authorised":"Leo","service":"B"},{"name":"Will James","authorised":"Flo","service":"B"},{"name":"John Gartside","authorised":"Leo","service":"B"},{"name":"Alex Bukur","authorised":"Leo","service":"B"},{"name":"Bay Andreadis","authorised":"Leo","service":"B"},{"name":"Clementine Curham","authorised":"Leo","service":"B"},{"name":"Ada Ucuncu","authorised":"Leo","service":"B"},{"name":"Paddy Purves","authorised":"Leo","service":"B"}]
...
#sort the list into the different services
r = []
l = []
b = []
s = []
...
for i in list:
    if i["name"] in [x["id"] for x in R]:
        r.append(i)
    elif i["name"] in [x["id"] for x in L]:
        l.append(i)
    elif i["name"] in [x["id"] for x in B]:
        b.append(i)
    elif i["name"] in [x["id"] for x in S]:
        s.append(i)
    elif i["name"] in [x["id"] for x in T]:
        t.append(i)
